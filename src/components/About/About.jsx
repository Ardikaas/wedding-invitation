...
const About = () => {
  return (
    <div className="about-container">
      <div className="about">
        <img className="about-bismil" src={bismil} alt="" />
        ...
        <img className="about-fp" src={fpce} alt="" />
        <img className="about-name-ce" src={namace} alt="" />
        <h4>Putri pertama dari :</h4>
        <h4>Bapak Hermansyah & Ibu Wiwik</h4>
        <img className="about-ring" src={ring} alt="" />
        <img className="about-fp" src={fpco} alt="" />
        <img className="about-name-co" src={namaco} alt="" />
